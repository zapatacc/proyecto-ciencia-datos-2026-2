...
El módulo lleva al estudiantado desde la verificación de herramientas hasta una primera API local. Después de aislar y reproducir las dependencias de un proyecto, el grupo construye y prueba una primera API con FastAPI.

1. [Clase 1 — Bienvenida, guía de aprendizaje y verificación técnica](clase-01-bienvenida.ipynb)
